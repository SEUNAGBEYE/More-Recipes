            ...
            <div className="card" id="profile-card">
              ...
              <div className="row">
                <div className="col-xs-12 col-sm-12 col-md-12">
                  <Link to="#" target='_blank' className="fa fa-dribbble icons"></Link> 
                  <Link to="#" target='_blank' className="fa fa-twitter icons"></Link> 
                  <Link to="#" target='_blank' className="fa fa-linkedin icons"></Link> 
                  <Link to="#" target='_blank' className="fa fa-facebook icons"></Link> 
                  <Link to={`mailto:${this.props.auth.user.email}`} target='_blank' className="fa fa-envelope icons"></Link>
                </div>
                  ...
                  <div className="modal-body">
                    <form id="form">
                      <fieldset className="form-group">
                        <label htmlFor="first_name" class="form-inline">First Name</label>
                ...
                <div className="modal-content">
                  ...
                  <div className="modal-body">
                    <form action="" id="form">
                      ...
                      <fieldset className="form-group">
                        <label htmlFor="confirm_password" class="form-inline">Confirm Password</label>
